"""
From Diffusion Policy by Cheng Chi.
Source code: https://github.com/real-stanford/diffusion_policy/blob/main/diffusion_policy/env/pusht/pusht_env.py
"""
import gym
...
from robomimic.utils.pusht_utils import DrawOptions
...
class EnvPushT(EB.EnvBase, gym.Env):
    ...
    def step(self, action):
        ...
        # compute reward
        goal_body = self.get_goal(self.goal_pose)
